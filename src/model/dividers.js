...
const witnessDividers = [
  {
    section: 0,
    paras: [
      'There are three sections to this survey.',
      'No question is compulsory and you can exit the process any time by closing the browser.',
      "The next few questions are about what you've witnessed. Your answers will tell us what is really happening, and where we need to act to create change.",
      'At the end of this report, you will be able to confirm your submission and that you give permission for the anonymous data to be used towards a movement of change. ',
    ],
  },
  {
...
export { firstDividers, witnessDividers };
