      ...
      <ContentWrapper>
        <Container>
          <FlexColumn>
            ...
            <p>
              All your answers will be treated in the strictest confidence. Only
              four members of staff will have access to your answers, which we
              will use to inform our work on making the music industry safer.
            </p>
            <h2>Why does the MU Safe Space exist?</h2>
            <p>
              A recent MU survey revealed that 48% of musicians have been
              sexually harassed at work. Not only have almost half of musicians
              experienced harassment at work, but:
            </p>
            <ul>
              <li>
            ...
            <p>
              We want to build up a picture of the problems that exist and seek
              long term solutions. We are campaigning for laws to protect
              musicians at work, and are on a mission to create cultural change
            ...
            <p>
              We want to hear from you if you do or wish to make all or part of
              your living from music. You could be a student or a professional.
              You could be employed, self employed, not working at the moment,
              or looking for work.
            </p>

            <p>
              We also want to hear from you if you are an amateur musician. You
              could be playing in a community orchestra or performing as part of
              a choir.
            </p>
            ...
            <p>
              ...
              clear in order to give you a choice as to whether to move forward
              or not.
            </p>
