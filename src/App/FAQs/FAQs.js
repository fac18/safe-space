          ...
          <FormContainer>
            <FlexColumn>
              ...
              <Collapse>
                ...
                <Type5 use='body1'>
                  Sexual assault is any type of sexual activity or contact that
                  is not consented to
                </Type5>
              </Collapse>
              <Collapse>
                ...
                <Type5 use='body1'>
                  We want to hear from you if you already make or wish to make
                  all or part of your living from music. You might be a student,
                  a professional; be employed, self employed, not working at the
                  moment, or looking for work. We also want to hear from you if
                  you are an amateur musician. You might be playing in a
                  community orchestra or performing as part of a choir.
                </Type5>
                <Type5 use='body1'>
                  We need as many musicians as possible to share their
                  experiences. The more experiences musicians share, the easier
                  it will be for us to spot patterns and identify where we need
                  to focus our work to create meaningful and lasting change.
                </Type5>
                <Type5 use='body1'>
                  If you are aged 16 or under, or the incident happened when you
                  were 16 or under, it will not be covered by this survey.
                  Please contact the{' '}
              ...
              <Collapse>
                ...
                <Type5 use='body1'>
                  We may be able to raise a complaint with the employer,
                  engager, or even directly with the perpetrator.
                </Type5>
                <Type5 use='body1'>
              ...
              <Collapse>
                ...
                <Type5 use='body1'>
                  We are very limited in terms of what can be done industrially
                  to address a complaint of a sexual assault.
                </Type5>
                <Type5 use='body1'>
